...
class TF_THEME extends TF_TFUSE {
    ...
    function __construct() {
        ...
        $this->action = !empty($_REQUEST['action']) ? mysql_real_escape_string(strtolower(trim(strip_tags($_REQUEST['action'])))) : '';
        $this->page = !empty($_REQUEST['page']) ? mysql_real_escape_string(strtolower(trim(strip_tags($_REQUEST['page'])))) : '';
        $this->taxonomy = !empty($_REQUEST['taxonomy']) ? mysql_real_escape_string(strtolower(trim(strip_tags($_REQUEST['taxonomy'])))) : '';
