...
$options = array(
    ...
    // Single Image
    array('name' => 'Is this a freebie?',
        'desc' => 'What to add a freebie archive?',
        'id' => TF_THEME_PREFIX . '_as_freebies',
        'value' => '',
        'type' => 'checkbox'
    ),
    array('name' => 'Attachment',
        'desc' => 'Upload attachment (.zip, .jpg, .png, .psd)',
        'id' => TF_THEME_PREFIX . '_attach',
        'value' => '',
        'type' => 'upload',
        'media' => 'file',
        'divider' => true
