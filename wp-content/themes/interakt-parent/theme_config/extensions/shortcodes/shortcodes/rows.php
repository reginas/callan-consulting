...
$atts = array(
    ...
    'options' => array(
        array(
            'name' => 'Class',
            'desc' => 'Specifies one or more class names for an shortcode ex:box box_border box_white,box_light_gray,box_gray<br>
                        box_green,box_yellow,box_blue,box_pink,box_red',
