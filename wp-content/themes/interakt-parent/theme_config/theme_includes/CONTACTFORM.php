...
if ( !empty($_POST['email']) )
{
    ...
    $already_used = array('email','name','message','subject','ajax');
    $attach = '';
    ...
    if($errorC == false)
    {
        ...
        $message = __('You have a new message!','tfuse').' <br />'. $the_email. $the_name.$the_subject.
